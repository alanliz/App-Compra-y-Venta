...
//            binding.EtEmail.error = "Favor de ingresar un correo electronico"
//            binding.EtEmail.requestFocus()
//        } else if (password.isEmpty()){
//            binding.EtPassword.error = "Ingrese una contraseña válida"
//            binding.EtPassword.requestFocus()
//        } else if(r_password.isEmpty()){
//            binding.EtRPassword.error = " Favor de confirmar la contraseña"
...
//                Toast.makeText(this, "No se registró el usuario. ERROR: ${exception.message}",
...
//
//
//private fun Registro_email.llenarInfoBD() {
...
//        .addOnFailureListener{ exception ->
//            progressDialog.dismiss()
//            Toast.makeText(this, "No se pudo registrar. ERROR: ${exception.message}.", Toast.LENGTH_SHORT).show()
//        }
//
//
//}
...
class Registro_email : AppCompatActivity() {
    ...
    private fun llenarInfoBD() {
        progressDialog.setMessage("Guardar información")
